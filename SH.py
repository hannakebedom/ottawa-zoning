...
if __name__ == '__main__':
    ...
    plt.plot(*Polygon(subject_polygon).exterior.xy)
    clipping_polygon = np.array(clipping_polygon)
    print(clipping_polygon)
    plt.plot(*Polygon(clipping_polygon).exterior.xy)
    clipped_polygon = Polygon(clip(subject_polygon,clipping_polygon))
    print(clipped_polygon)
    plt.plot(*clipped_polygon.exterior.xy)
    plt.show()
